...
function About(props: Props) {
  return (
    <div className="p-12 flex items-center justify-center bg-violet-blue text-center text-3xl">
      ...
      facere. Corporis exercitationem necessitatibus, nihil rerum consequuntur
      rem, libero pariatur tenetur alias doloremque dignissimos tempore quod
      consectetur non quam fugit ipsum!
    </div>
  )
}
